...
def main():
    """Streamlit application for predicting the price of an apartment for sale."""
    ...
    # Check if predict module exists
    try:
        from predict import Item
    except ModuleNotFoundError:
        st.error("The 'predict' module could not be found. Make sure it exists in your project directory.")
